...
Please disable other plugins or themes until you find the one that causes the problem, and contact the developers.
In the message include the link to WordPress ticket about menu items issue with WordPress](http://core.trac.wordpress.org/ticket/18584 where they can see detailed info on how to fix the problem.
